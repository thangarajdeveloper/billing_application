...
def BlogDetailView(request, id):
    ...
    return render(request, 'app/detailview.html', context)
...
def BlogAdd(request):
    ...
    return render(request, 'app/addblog.html', context)
...
def BlogUpdate(request, id):
    ...
    return render(request, 'app/updateblog.html', context)
...
def BlogDelete(request, id):
    ...
    return render(request, 'app/detailview.html', {'message': 'deleted'})
